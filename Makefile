all:
	...
	nvcc -std=c++11 -O3 --compiler-options '-fPIC' -c src/tensorNet_wrap.cxx -I/usr/include/python2.7/ -I/usr/local/lib/python2.7/dist-packages/numpy/core/include/ -Isrc/
